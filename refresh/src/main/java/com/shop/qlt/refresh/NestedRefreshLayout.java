...
public class NestedRefreshLayout extends ViewGroup
    ...
    private OnRollListener mRollListener;
...
//                Logger.i(pullHelper.canTouchUpToRefresh());
                if (!pullHelper.canTouchUpToRefresh()) {
//                    if (mRollListener != null) {
//                        roll = 0;
//                        mRollListener.onRollView(0);
//                    }
                }
...
//        final boolean canFling = canFilngUp || canFilngDown;
    ...
    public interface OnRollListener {
        void onRollView(int roll);
    }

    public void onSetRollListener(OnRollListener listener){
